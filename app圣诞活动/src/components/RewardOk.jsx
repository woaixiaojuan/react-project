...
class RewardOk extends React.Component {
  ...
  render() {
    ...
    const centerStyle = {
      ...
      height: '4.4rem',
      marginLeft: '-1.9rem',
      background: `url(${ENV.centerImg}) no-repeat`,
      backgroundSize: 'cover',
      zIndex: 1200,
    };
      ...
      <div>
        <div style={divStyle} id="userMsg">
              ...
              <FormItem>
                <Row type="flex" justify="space-between">
                  ...
                  <Col style={{ width: '130px' }}>
                    <Button style={{ width: '100%' }}disabled={this.state.disabled} size="large" onClick={this.handleCaptcha.bind(this)}>{_time}</Button>
                  </Col>
                </Row>
              </FormItem>
            </Form>
          ...
          <div style={centerStyle}>
            ...
            <p style={{ overflow: 'hidden', width: '1.5rem', margin: '4px auto 0', height: '18px' }}>{rewardName}</p>
          </div>
          <Button type="primary" style={{ position: 'absolute', bottom: '15px', left: '50%', marginLeft: '-52px' }} onClick={this.setForm.bind(this)}>填写领奖信息</Button>
        </div>
        <div style={noStyle}>
          <Button type="primary" style={{ position: 'absolute', bottom: '15px', left: '50%', marginLeft: '-0.75rem', width: '1.5rem' }} onClick={this.backApp.bind(this)}>确定</Button>
        </div>
        <div style={endStyle}>
          <Button type="primary" style={{ position: 'absolute', bottom: '15px', left: '50%', marginLeft: '-0.75rem', width: '1.5rem' }} onClick={this.backApp.bind(this)}>确定</Button>
...
// <Button type="primary" style={{ position: 'absolute', bottom: '15px', left: '20px', width: '1.5rem' }} onClick={this.backApp.bind(this)}>返回</Button>
