...
import { Col, Row, Modal, Form, Input, message, Upload, Icon, Select } from 'antd';
...
class ZuoPinModal extends React.Component {
  ...
  render() {
    const { confirmLoading, sourceList, zuoPinModalIsShow, addOrEdit, cacheMediaSrc, isMediaShow } = this.props.zuoPinStore;
